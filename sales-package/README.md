...
|--------|--------|--------------|
| `01-pitch/` | One-pager, sunum HTML, konuşma notları | Satış / kurucu |
| `02-commercial/` | Fiyat politikası, teklif şablonu, ROI | Satış / mali işler |
| `03-compliance/` | KVKK özeti, güvenlik brifi | IT / hukuk |
| `04-brand/` | Logo, renkler, hero görseller | Tasarım / sunum |
| `05-media/` | Reklam ve kullanım videosu senaryoları | Pazarlama |
| `06-store/` | Mağaza listeleme özeti | Ürün |

## Görüşme akışı (önerilen)
...
- Demo: `demo@kentiva.app`
- Ticari: `info@kentiva.app`
