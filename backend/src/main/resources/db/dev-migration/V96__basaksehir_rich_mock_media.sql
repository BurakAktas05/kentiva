-- V96 (dev): Başakşehir mock verilerine fotoğraflı ihbarlar, kan/kayıp/eşya ilanları ve duyuru görselleri
-- Production eşdeğeri: db/migration/V61__basaksehir_rich_mock_media.sql
