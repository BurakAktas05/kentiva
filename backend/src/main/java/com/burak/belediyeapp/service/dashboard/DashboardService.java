    ...
    public DashboardStatsResponse getStats(AppUser user) {
        if (tenantAccess.isSuperAdmin(user)) {
            return new DashboardStatsResponse(
                    ...
                    reportRepository.countByReportStatus(ReportStatus.OUT_OF_JURISDICTION),
        ...
        return new DashboardStatsResponse(
                ...
                reportRepository.countByMunicipalityIdAndReportStatusAndHiddenFromMunicipalityFalse(municipalityId, ReportStatus.OUT_OF_JURISDICTION),
