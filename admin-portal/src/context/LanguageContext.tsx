...
const translations = {
  tr: {
    ...
    surveys: 'Anketler',
    events_outages: 'Kesintiler & Etkinlikler',
    staff: 'Personeller',
    ...
    recent_reports: 'Son İhbarlar',
    all_reports: 'Tümünü Gör',
    total_reports: 'Toplam İhbar',
    pending: 'Bekleyen',
  ...
  en: {
    ...
    overview_group: 'General',
    tracking_group: 'Reports & Tracking',
    pr_group: 'Communications',
