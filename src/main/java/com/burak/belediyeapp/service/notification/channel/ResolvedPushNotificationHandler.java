...
public class ResolvedPushNotificationHandler implements ReportStatusNotificationHandler {
    ...
    public void deliver(AppUser reporter, Report report, String staffNote) {
        MunicipalityMessageService.PushMessage push = municipalityMessageService.buildResolvedPush(
        ...
        firebasePushClient.send(
                ...
                push.title(),
                push.body(),
                Map.of("reportId", report.getId(), "type", "REPORT_RESOLVED"));
    }
}
